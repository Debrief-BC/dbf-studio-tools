...
dbf-debug wrap other dbf-* libraries and can be used to debug Debrief transactions.
...
```bash
npm install dbf-debug
```

## Development

```javascript
var Debugger = require('dbf-debug').EthDebugger
var BreakpointManager = require('dbf-debug').BreakpointManager
